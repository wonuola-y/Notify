    ...
    <div>
      ...
      <div className="flex w-full my-2 mx-2  items-center justify-between">
        <div className="text-gray-500 text-[10px] flex items-center ">
          ...
          />
          <p className="mx-4">{liked ? " You and Nathan Peterson liked" : "Nathan Peterson liked"}</p>
        </div>
        <button className="my-4 bg-[#0A327B] text-white p-3 rounded text-[10px] hover:bg-blue-700 ">
